    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.row}>
          <Text style={styles.colLeft}>Trận đấu: </Text>
        ...
        <View style={styles.row}>
          <Text style={styles.colLeft}>Địa điểm:</Text>
          <Text style={styles.colRight}>{movieData?.[0]?.director}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.colLeft}>Khuôn khổ:</Text>
          <Text style={styles.colRight}>{movieData?.[0]?.country}</Text>
        </View>
        {/* <NewsSlider /> */}
      </ScrollView>
      ...
      >
        <Text style={styles.textBooking}>Đặt vé tại K+ Sport</Text>
      </TouchableOpacity>
